...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables create --name <NAME> --column-info <JSON_SCHEMA> [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables create --project-id "my-project" --customer-id "abc" --region "us" --name "known_bad_ips" --description "List of malicious IPs" --column-info '[{"columnIndex": 0, "originalColumn": "ip", "keyColumn": true, "repeatedValues": false, "columnType": "STRING"}]'
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables add-rows --table-name <TABLE_NAME> --rows <JSON_SCHEMA>
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables add-rows --project-id "my-project" --customer-id "abc" --region "us" --table-name "known_bad_ips" --rows '[{"values": ["10.10.10.10"]}, {"values": ["10.10.10.11"]}]'
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables list [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables list --project-id "my-project" --customer-id "abc" --region "us"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables list-rows --table-name <TABLE_NAME> [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables list-rows --project-id "my-project" --customer-id "abc" --region "us" --table-name "known_bad_ips" --filter "192.168"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables delete-row --table-name <TABLE_NAME> --row-id <ROW_ID>
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py data-tables delete-row --project-id "my-project" --customer-id "abc" --region "us" --table-name "known_bad_ips" --row-id "row_12345abc"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rules [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rules --project-id "my-project" --customer-id "abc" --region "us"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rule-errors --rule-id <RULE_ID> [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rule-errors --project-id "my-project" --customer-id "abc" --region "us" --rule-id "ru_12345678-1234-1234-1234-1234567890ab"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection create-rule --rule "<YARA_L_TEXT>"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection get-rule --rule-id <RULE_ID> [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection get-rule --project-id "my-project" --customer-id "abc" --region "us" --rule-id "ru_12345678-1234-1234-1234-1234567890ab"
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection get-rule --project-id "my-project" --customer-id "abc" --region "us" --rule-id "ru_12345678-1234-1234-1234-1234567890ab@v_abcdef_123456" --view "BASIC"
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection validate-rule --rule "<YARA_L_TEXT>"
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection validate-rule --project-id "my-project" --customer-id "abc" --region "us" --rule 'rule test_rule { meta: description = "Test" events: $e.metadata.event_type = "USER_LOGIN" condition: $e }'
```
...
**Usage:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rule-detections --rule-id <RULE_ID> [options]
```
...
**Examples:**
```bash
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rule-detections --project-id "my-project" --customer-id "abc" --region "us" --rule-id "ru_12345678-1234-1234-1234-1234567890ab" --page-size 10
python3 /home/admin_cmmartin_altostrat_com/google-secops-skills/src/secops.py detection list-rule-detections --project-id "my-project" --customer-id "abc" --region "us" --rule-id "ru_12345678-1234-1234-1234-1234567890ab@v_abcdef_123456" --alert-state "ALERTING" --start-time "2025-10-01T00:00:00Z" --end-time "2025-10-02T00:00:00Z"
```
